...
// находим и выносим в переменную блок .map__filters-container, чтобы вставить карточки перед ним
...
var renderCard = function (ads) {
  ...
  cardElement.querySelector('.popup__description').textContent = ads.offer.descrition;
